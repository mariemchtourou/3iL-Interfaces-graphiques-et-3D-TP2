...
public class Square implements GLEventListener {
    ...
    public void display(GLAutoDrawable gLDrawable) {
        ...
        gl.glColor3f(1.0f, 0.0f, 0.5f); // Set the color for the next drawing
        gl.glVertex3f(-1.0f, 1.0f, 0.0f); // Set a point at top left
        gl.glColor3f(0.0f, 0.5f, 0.5f); // Set the color for the next drawing
        gl.glVertex3f(1.0f, 1.0f, 0.0f); // Set a point at top right
        gl.glColor3f(0.0f, 1.0f, 0.4f); // Set the color for the next drawing
